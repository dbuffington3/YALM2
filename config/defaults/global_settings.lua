return {
	...
	["commands"] = {
		...
		["TaskInfo"] = {
			["args"] = "[status|items|refresh]",
			["name"] = "TaskInfo",
			["trigger"] = "taskinfo",
			["help"] = "Display task awareness information and quest item tracking",
			["category"] = "Configuration",
		},
		["QueryItem"] = {
			["args"] = "[item_id|item_name] [all]",
			["name"] = "QueryItem",
			["trigger"] = "queryitem",
			["help"] = "Query database for detailed item information including quest flags",
			["category"] = "Debug",
		},
		["DebugLoot"] = {
			["args"] = "",
