...
--- Set quest items directly from external sources (e.g., yalm2_native_quest.lua)
--- This allows other modules to populate the quest_items cache
tasks.set_quest_items = function(quest_items_table)
    if quest_items_table and type(quest_items_table) == "table" then
        task_data.quest_items = quest_items_table
        return true
    end
    return false
end
